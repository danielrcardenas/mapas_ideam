							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<ul>
										<li><a style="margin-left: 20px" href="http://www.cambioclimatico.gov.co/jsp/index.jsf" target="_blank">
										Portal de cambio Clim&aacute;tico </a>
										</li>
										
										<li>
										<a style="margin-left: 20px" href="https://www.siac.gov.co" target="_blank">
										Portal Sistema de Ambiental para Colombia SIAC</a>
										</li>
										
										<li>
										<a style="margin-left: 20px" href="https://www.minambiente.gov.co/index.php/ambientes-y-desarrollos-sostenibles/cambio-climatico" target="_blank">
										Ministerio de Ambiente y Desarrollo Sostenible - Cambio Clim&aacute;tico</a>
										</li>
										
										<li>
										<a style="margin-left: 20px" href="https://www.minambiente.gov.co/index.php/ambientes-y-desarrollos-sostenibles/bosques-biodiversidad-y-servicios-ecosistematicos" target="_blank">
										Ministerio de Ambiente y Desarrollo Sostenible - Bosques, biodiversidad y servicios ecosist&eacute;micos	
										</a>
										</li>
										
										<li>
										<a style="margin-left: 20px" href="http://institucional.ideam.gov.co/jsp/3136" target="_blank">
										Grupo de Observaci&oacute;n de la Tierra - Colombia </a>
										</li>
										
										<li>
										<a style="margin-left: 20px" href="http://www.earthobservations.org/index.php" target="_blank">
										GEO</a>
										</li>
