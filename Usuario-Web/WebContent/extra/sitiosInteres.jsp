...
<meta http-equiv="Refresh" content="2;url=<%=basePath2%>Usuario-Web/extra/enlacesRel.jsp">
...
<body>
Espere unos segundos mientras se redirecciona a la pagina, si no es asi pulse <a href="<%=basePath2%>Usuario-Web/extra/enlacesRel.jsp">aqui</a>.
</body>
</html>
