							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2>Aspectos Generales Colombia</h2>

										<p for="exampleInputEmail1" style="margin: 30px">
											El Sistema incorporó en el año 2013, al procesamiento de datos para la generación de los productos y servicios de información,   un total de 664 imágenes Landsat.
										</p>
