...
<%if (errorRol == "Yes") {%>
	alert("El rol actual del usuario no permite cambiar la contrase&ntilde;a de esta manera,\n"
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<ul>
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Documento_base_imagenes_v3_sept202011')">
										** Documento t&eacute;cnico de referencia para la utilizaci&oacute;n de im&aacute;genes de sensores remotos en la cuantificaci&oacute;n de la deforestaci&oacute;n y estimaci&oacute;n del almacenamiento de carbono</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Memoria_Tecnica_Deforestacion')">
										** Memoria t&eacute;cnica de la cuantificaci&oacute;n de la deforestaci&oacute;n hist&oacute;rica nacional –escalas gruesa y fina</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Emisiones')">
										** Estimaci&oacute;n Emisiones de di&oacute;xido de carbono 2005-2010 generadas por Deforestaci&oacute;n</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Estimacion_Carbono_2005')">
										** Estimaci&oacute;n de Reservas de carbono almacenada Bosques naturales a&ntilde;o 2005 </a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Estimacion_Carbono_2010')">
										** Estimaci&oacute;n de Reservas de carbono almacenada en la biomasa a&eacute;rea de los Bosques naturales de Colombia a&ntilde;o 2010</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Biomasa_Sensores')">
										** Estimaci&oacute;n de la biomasa a&eacute;rea usando datos de campo e informaci&oacute;n de sensores remotos</a>
										</li>
							...
							<div class="menu-ministerios menu-postscript">
								<ul>
									...
									<li><a class="min-educacion"
										href="http://www.mineducacion.gov.co/1621/w3-channel.html">MinEducaci&oacute;n</a></li>
...
<!-- 								<ul> -->
<!-- 									<li><a >Visitas Casa de Nari&ntilde;o</a></li> -->
				...
				<div class="section">
					<div class="section-inner clearfix">
						...
						<div class="copyriht">
							...
							<p>Carrera 10 No. 20-30 Bogot&aacute; DC. - PBX:(571)3527160 - Línea
								nacional 018000110012 - Pron&oacute;stico y Alertas (571) 3527180</p>
							<p>Horario de Atenci&oacute;n: Lunes a Viernes 8:00 AM a 4:00 PM</p>
						</div>
