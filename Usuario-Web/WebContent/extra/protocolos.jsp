							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<ul>
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Protocolo_Nacional_Carbono')">
										** Protocolo para la estimaci&oacute;n Nacional-Subnacional de Biomasa- Carbono en Colombia</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Protocolo_Nacional_PDI')">
										** Protocolo Nacional Procesamiento Digital de Im&aacute;genes para cuantificaci&oacute;n de la Deforestaci&oacute;n en Colombia</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('Protocolo_Subnacional_PDI')">
										** Protocolo de Procesamiento Digital de Im&aacute;genes para cuantificaci&oacute;n de la Deforestaci&oacute;n nivel Subnacional </a>
										</li>
