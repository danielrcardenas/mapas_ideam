...
/**
 * ModificarInventarioSueloServlet.java Servlet que se encarga de proporcionar
 * los datos para realizar una actualizacion del inventario de suelos
 * 
 * SMBC Proyecto: Sistema de Monitoreo de Bosques y Carbono
 * 
 * @author Julio Cesar Sanchez Torres Oct 22 de 2013
 */
public class ModificarInventarioSueloServlet extends HttpServlet {
	...
	if (!nuevaMetod) {
	    ...
	    mis.actualizaInventarioSuelo(parcela, metodologia, profundidad,
	    ...
	    mis.actualizaInventarioSueloConMetodologia(parcela,
