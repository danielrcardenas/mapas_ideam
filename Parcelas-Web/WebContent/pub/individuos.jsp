							...
							<div id="block-top-menu" class="block block-menu">
								<div class="content">
									...
									<ul class="social-menu item-list">
										<li class="menu-item twitter first"><a ></a></li>
						...
						.substring(0, 50) + "..." : n.getDescripcion()%>
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="div_iframe">
									<iframe src="../../Importador/busqueda_individuos.jsp?parametros=<%=request.getParameter("parametros")%>" style="width:100%; height: 1024px; overflow: scroll; border: 0 none;"></iframe>
									</div>
