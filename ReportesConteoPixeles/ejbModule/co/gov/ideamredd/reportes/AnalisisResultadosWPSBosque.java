...
public class AnalisisResultadosWPSBosque extends AnalisisResultadosWPS {
	...
	@EJB
	IngresaInformacionReporte infr = new IngresaInformacionReporte();
	...
	private String rutaImagenSalidaGeoproceso;
	public void nuevoAnalisisResultadosWPSBosque(Integer tipoReporte, Integer ItemCruce,
			String keywordSalidaGeoproceso, Integer periodos[]) {
		...
		rutaImagenSalidaGeoproceso = super.getRutaSalidaGeoproceso(keywordSalidaGeoproceso);
		ArrayList<String> valores = super.obtenerPixelesGDAL(tipoReporte,
				ItemCruce, rutaImagenSalidaGeoproceso);
		int index = 0;
		for (int i = 1; i < valores.size(); i += 3) {
