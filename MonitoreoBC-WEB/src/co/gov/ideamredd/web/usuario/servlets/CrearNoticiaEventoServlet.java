...
import co.gov.ideamredd.web.usuario.dao.RegistraNoticiaEvento;

/**
 * Servlet usado para crear una noticia o evento
 */
public class CrearNoticiaEventoServlet extends HttpServlet {
	...
	UploadFile file;
	String ubicacionArchivo = Util.obtenerClave("ruta.imagenes.noticias", par);
	String nombre;
	String tipo;
	String descripcion;
	String imagen;
