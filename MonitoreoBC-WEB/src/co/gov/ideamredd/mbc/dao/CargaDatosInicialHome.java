...
/**
 * Métodos para cargar datos iniciales del home 
 * 
 */
public class CargaDatosInicialHome {
	...
	/**
	 * Metodo para obtener noticas de inicio.
	 */
	public static ArrayList<Noticias> getNoticiasHome() {
		ArrayList<Noticias> noticias = new ArrayList<Noticias>();
		try {
			conn = dataSource.getConnection();
			CallableStatement consultaNoticias = conn.prepareCall("{call RED_PK_TABLASTIPO.consultaNoticiaHome(?)}");
	...
	/**
	 * Metodo para obtener eventos inicio.
	 */
	public static ArrayList<Noticias> getEventosHome() {
		ArrayList<Noticias> eventos = new ArrayList<Noticias>();
		try {
			conn = dataSource.getConnection();
			CallableStatement consultaEventos = conn.prepareCall("{call RED_PK_TABLASTIPO.consultaEventoHome(?)}");
