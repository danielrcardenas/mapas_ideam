...
Integer idNoticia=Integer.parseInt(request.getParameter("idNoticia"));
Noticias noticia = CargaNoticiasYEventos.consultarNoticiaEvento(idNoticia);
 	
%>
<title><%=msj.getString("detalle_noticia") %></title>
				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja"><%=msj.getString("detalle_noticia") %></h2>
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<p for="exampleInputEmail1" style="margin-left: 20px;font-size: 18px;font-weight: bold;" ><%=noticia.getNombre() %></p>

										<div style="margin: 20px;">
										<%if(!noticia.getPathImagen().equals("nulo")){%>
											<img style="width: 600px" src="/MonitoreoBC-WEB/imagenNoticiaServlet?nomImagenParam=<%=noticia.getPathImagen()%>">
										<%} %>
										</div>

										<div style="margin: 10px;width: 580px;font-size: 18px;text-align: justify;">
											<p for="exampleInputEmail1" style="margin-left: 10px">
