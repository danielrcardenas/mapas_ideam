...
inicializarNavegador();       
       ...
       $('#green').smartpaginator({ totalrecords: <%=eventos.size()%>, recordsperpage: 5, datacontainer: 'divEventos', dataelement: 'table', initval: 0, next: 'Next', prev: 'Prev', first: 'First', last: 'Last', theme: 'green' });
				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja"><%=msj.getString("home.eventos") %></h2>
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<div id="divEventos">
											<%=UI.getEventos(msj, false) %>
										</div>
										
										<div id="green" class="green-pager"></div>
											
										<div class="form-actions">
											<input type="button" value="<%=msj.getString("volver")%>" class="btn btn-default" onclick="javascript:history.back(1);">
										</div>
