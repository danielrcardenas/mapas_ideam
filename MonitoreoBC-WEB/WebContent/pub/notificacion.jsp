							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2><%=msj.getString("registroUsuario.notifi.confirmRegitro")%></h2>

										<p for="exampleInputEmail1" style="margin-left: 20px">
											<%=msj.getString("registroUsuario.notifi.parrafo")%>
										</p>
										<div class="form-actions">
										<input type="button" class="btn btn-default" value="<%=msj.getString("registroUsuario.notifi.aceptar")%>" onclick="location.href='/MonitoreoBC-WEB';" />
										</div>
