...
<%}%>
	...
	function enviarFormularioReporte()
	{
	    ...
	    {
			setTimeout(function(){document.location.href = '/'+"MonitoreoBC-WEB/pub/consultarReporteBosques.jsp"},500);
<%-- 			location.href = '/'+"MonitoreoBC-WEB/pub/consultarReporteBosques.jsp"; --%>
			return;
		}
