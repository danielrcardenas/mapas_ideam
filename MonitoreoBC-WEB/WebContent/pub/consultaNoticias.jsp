...
<script>
    $(document).ready(function() {
       ...
       $('#green').smartpaginator({ totalrecords: <%=noticias.size()%>, recordsperpage: 5, datacontainer: 'divNoticias', dataelement: 'table', initval: 0, next: 'Next', prev: 'Prev', first: 'First', last: 'Last', theme: 'green' });
				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja"><%=msj.getString("home.noticias") %></h2>
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										<div id="divNoticias">
											<%=UI.getNoticias(msj, false) %>									
										</div>
																				
										<div id="green" class="green-pager">
										</div>
