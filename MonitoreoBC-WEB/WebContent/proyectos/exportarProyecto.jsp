...
<script>
	...
	function irAHome(){
		document.location.href = "/MonitoreoBC-WEB/home.jsp";
	}
	
	function DescargarReporte(tipo){
		
		document.getElementById('hidTipoDescarga').value=tipo;
		document.getElementById('formColumnas').submit();
	}
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2>Exportar Proyectos</h2>
										<form id="formColumnas" method="post" action="/MonitoreoBC-WEB/descargaProyectosServlet" >
										<div style="margin: 20px;width: 350p;font-size: 18px;text-align: justify;">
											<p for="exampleInputEmail1" style="margin-left: 20px">
												<div class="form-group">
															<label for="exampleInputEmail1">Selecciona las columnas a exportar
															</label>
															<label for="exampleInputEmail1">(Mantener presionada la tecla Ctrl para seleccionar mas de una)</label>
															<div class="select-wrapper" style="width: 350px">
																<select id="selColumnas" name="selColumnas" multiple="multiple" name="tipoBosque" 
																style="height: 350px" style="width: 340px" >
																	<option value="Codigo_Proyecto" selected="selected">Codigo Proyecto</option>
																	<option value="Nombre_Proyecto">Nombre Proyecto</option>
																	<option value="Area_Proyecto">Area Proyecto</option>
																	<option value="Descripcion_Area">Descripcion Area</option>
																	<option value="Nombre_Pais">Nombre Pais</option>
																	<option value="Nombre_Departamento">Nombre Departamento</option>
																	<option value="Nombre_Municipio">Nombre Municipio</option>
																	<option value="Tipo_De_Bosque">Tipo de Bosque</option>
																	<option value="CAR">CAR</option>
																	<option value="Tipo_De_Proyecto">Tipo de Proyecto</option>
																	<option value="Fecha_De_Inicio">Fecha de Inicio</option>
																	<option value="Fecha_De_Finalizacion">Fecha de Finalizacion</option>
																	<option value="Tenencia_De_La_Tierra">Tenencia de la tierra</option>
																	<option value="Actividad_REDD">Actividad REDD</option>
																	<option value="Cantidad_De_CO2_A_Reducir">Cantidad de CO2 A Reducir</option>
																	<option value="Tasa_Deforestacion_A_Reducir">Tasa Deforestacion a Reducir</option>
																	<option value="Nombre_Metodologia">Nombre Metodologia</option>
																	<option value="Descripcion_Metodologia">Descripcion Metodologia</option>
																	<option value="Ecuacion_Metodologia">Ecuacion Metodologia</option>
																</select>
															</div> 
														</div>
											</p>
										...
										<input type="hidden" name="hidTipoDescarga" id="hidTipoDescarga" value="">
