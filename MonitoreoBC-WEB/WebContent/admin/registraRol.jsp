...
%>
	...
	function validarDatosForm(){
		...
		if($.inArray(nombreRol, listaRoles)!=-1){
			resultado=false;mensaje=mensaje+"-El nombre de rol ya existe\n";
		}
				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja"><%=msj.getString("Registro_de_Roles") %></h2>
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2><%=msj.getString("Formulario_de_Registro_de_Nuevo_Rol") %></h2>

										<form method="POST" action="/MonitoreoBC-WEB/registrarRolServlet" 
										...
										<input type="text" name="nombreRol" id="nombreRol" style="width: 280px">
										<br><br>
										...
										<input type="submit" value="<%=msj.getString("registrar") %>">
										<input type="button"
