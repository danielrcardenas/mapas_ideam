						...
						<div class="section-inner clearfix fondoformulario">
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="organigrama" >
										...
										<%if(usuario == null){ %>
										<ul>
										<li ><a class="primernivel">Usuarios</a>
											<ul >
										...
										<li ><a class="primernivel"><%=msj.getString("home.cifras")%></a>
											<ul >
										...
										<li ><a class="primernivel"><%=msj.getString("home.bosques.alertas")%></a>
											<ul >
										...
										<li ><a class="primernivel"><%=msj.getString("home.noticiasEventos")%></a>
 										    <ul > 
										...
										<%if(usuario != null){ %>
											...
											<li ><a class="primernivel"><%=msj.getString("menu_usuario")%></a>
												<ul >
										...
										<li ><a class="primernivel"><%=msj.getString("home.visor")%></a>
											<ul >
										...
										<li ><a class="primernivel"><%=msj.getString("home.links")%></a>
											<ul>
										...
										<li ><a class="primernivel" href='/MonitoreoBC-WEB/extra/socios.jsp'><%= msj.getString("socios") %></a></li>
