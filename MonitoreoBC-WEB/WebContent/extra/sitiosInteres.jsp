...
try {
	...
	if(sesion.getAttribute("i18nAuxLeng") != null )
	{
		i18n.setLenguaje((String)sesion.getAttribute("i18nAuxLeng"));
		i18n.setPais((String)sesion.getAttribute("i18nAuxPais"));
	}
	else
...
<meta http-equiv="Refresh" content="2;url=/MonitoreoBC-WEB/extra/enlacesRel.jsp">
...
<body>
Espere unos segundos mientras se redirecciona a la pagina, si no es asi pulse <a href="/MonitoreoBC-WEB/extra/enlacesRel.jsp">aqui</a>.
</body>
</html>
