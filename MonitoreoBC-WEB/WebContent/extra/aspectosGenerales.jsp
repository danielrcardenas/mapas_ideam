				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja"><%=msj.getString("pagina.AGenerales") %></h2>
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<div class="contenido">
										<% out.print(parametro.getParametro("contenido_aspectosgenerales_"+(Auxiliar.nzObjStr(i18n.getLenguaje(), "es")))); %>									
										</div>
