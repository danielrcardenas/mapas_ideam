...
%>
<title>Sistema de Monitoreo de Biomasa y Carbono</title><script type="text/javascript" src="../custom/manejo-listas.js"></script>
				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja"><%=msj.getString("home.links") %></h2>
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<div class="contenido">
										<% out.print(parametro.getParametro("contenido_enlacesrelacionados_"+(Auxiliar.nzObjStr(i18n.getLenguaje(), "es")))); %>									
										</div>
