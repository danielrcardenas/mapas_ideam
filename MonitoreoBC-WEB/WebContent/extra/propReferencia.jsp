				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja">Propuesta de nivel de referencia de las emisiones forestales por deforestación en la Amazonía de Colombia</h2>
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<ul>
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('2014_9_Dic_Nivel_de_Referencia','PDF')">
										** Documento PDF</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" onclick="descargaDocumento('2014_9_Dic_Nivel_de_Referencia','WORD')">
										** Documento Word</a>
										</li>
										
										<li><a style="margin: 20px; cursor: pointer;" href="http://seinekan.ideam.gov.co/SMBYC/ApolloPro.aspx" target="_blank">
										** Mapas</a>
										</li>
