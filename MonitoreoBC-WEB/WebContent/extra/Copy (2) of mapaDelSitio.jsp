										...
										<div class="topnav">
											<ul class="nav nav-tabs ">
												...
												<li >
													...
													<%=msj.getString("home.noticiasEventos")%> </a>
												</li>
												<%} %>
												<li class="active">
													<a href="#tab_default_3" data-toggle="tab">
													<%=msj.getString("home.cifras")%></a>
												</li>
												<li>
													<a href="#tab_default_4" data-toggle="tab">
													<%=msj.getString("home.bosques.alertas")%> </a>
												</li>
												<%if(usuario != null){ %>
												<li >
													<a href="#tab_default_5" data-toggle="tab">
													<%=msj.getString("menu_usuario")%></a>
												</li>
												<%} %>	
												<li >
												    <a href="#tab_default_6" data-toggle="tab">
												    <%=msj.getString("home.visor")%></a>
												 </li>   
												 <li >
												    <a href="#tab_default_7" data-toggle="tab">
												    <%=msj.getString("home.links")%></a>
												  </li> 
												  <li >
												    <a href="#tab_default_8" data-toggle="tab">
												    <%= msj.getString("socios") %></a>
												  </li>
									        ...
									        <div class="tab-content">
						                        ...
						                        <div class="tab-pane fade in active" id="tab_default_3">
