...
if (!request.isRequestedSessionIdValid() || sesion == null) { 
	response.sendRedirect("/MonitoreoBC-WEB/reg/indexLogOn.jsp"); 
	return;
}
...
<%-- 	<%=UI.getCommonForms(usuario, sesion, msj, diccionarioPermisos, i18n)%> --%>
	...
	<form id="home" action="/MonitoreoBC-WEB/idioma" method="post">
		...
		<div id="page" style="z-index: 1; position: absolute; margin-left: auto; margin-right: auto; left: 0; right: 0;">
			...
			<%=UI.getHeaderSinLogin(usuario, sesion, msj, diccionarioPermisos, i18n, request.getRequestURI()).replace("../img", "img")%>
			...
			<div id="preface" class="section-wrapper">
				<div class="section">
					<div class="section-inner clearfix">
						...
						<div class="block">
							<p class='error' >Usuario o clave incorrecta/Invalid username or password.  <a href="#" onclick="javascript:window.top.location='/MonitoreoBC-WEB/reg/indexLogOn.jsp'">Volver a intentar/Try again...</a></p>
						</div>
						<div>
