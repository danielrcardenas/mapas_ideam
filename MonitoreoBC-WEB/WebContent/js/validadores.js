...
function validarNumeros(e){
	...
	if (key > 47 && key < 58 || key ==45 || key==46 || key==8 || key==0) {
		return true;
	} else {
		return false;
}
...
function validePass(cadena) {  
	...
	if(caracter==true && numero==true && minuscula==true && mayuscula==true) {
		...
		alert("La password elegida no es segura. Introduzca al menos una may�scula, una min�scula, un n�mero y un car�cter simb�lico.");
		return false;
	}
} 
