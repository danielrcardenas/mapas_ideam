...
String nombreNoticia=(String)request.getSession().getAttribute("nombreNoticia");
							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2>Noticia o Evento Creado</h2>

										<p for="exampleInputEmail1" style="margin-left: 20px;font-size: 18px;font-weight: bold;" ><%=nombreNoticia %></p>

										<div style="margin: 20px;">
										<%if(!nombreImagenUsuario.equals("")){%>
											<img style="width: 600px" src="/MonitoreoBC-WEB/imagenNoticiaServlet?nomImagenParam=<%=nombreImagenUsuario%>">
										<%} %>
										</div>

										<div style="margin: 20px;width: 580p;font-size: 18px;text-align: justify;">
