...
if (sesion != null) {
	...
	String basePath = "/MonitoreoBC-WEB/";
	String basePath2 = "/MonitoreoBC-WEB/";

	basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/";
	basePath2 = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + "/";

	msj = (ResourceBundle)sesion.getAttribute("i18n");
...
LenguajeI18N i18n = null;
if (sesion != null) {
	i18n = (LenguajeI18N) sesion.getAttribute("i18nAux");
