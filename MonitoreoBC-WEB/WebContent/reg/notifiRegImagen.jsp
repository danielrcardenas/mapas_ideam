							...
							<div id="content">
								<div class="content-inner">
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2>Imagen Registrada</h2>

										<p for="exampleInputEmail1" style="margin-left: 20px">
											Su imagen ha sido registrada satisfactoriamente, cuando sea procesada y publicada se le notificara a su correo electrónico.
										</p>
										
										<div style="margin: 20px;">
											<img style="width: 600px" src="/MonitoreoBC-WEB/imagenServlet?nomImagenParam=<%=nombreImagenUsuario%>">
										</div>
