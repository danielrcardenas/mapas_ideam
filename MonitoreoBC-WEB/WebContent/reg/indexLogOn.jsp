...
<body class='sidebarlast front' onmouseover="popUpUsuariosAux()">
	...
	<form id="home" action="/MonitoreoBC-WEB/idioma" method="post">
		<input type="hidden" name="lenguaje" id="lenguaje"> <input type="hidden" name="pagina" id="pagina">
			...
			<div id="preface" class="section-wrapper">
				<div class="section">
					<div class="section-inner clearfix">
						...
						<div>
							<iframe id="iframe_mapa_wms" class="mapa_wms_reproductor" src="/MonitoreoBC-WEB/visorReproductor.jsp"></iframe>
						</div>
						<div class='leyenda'>
							<table class='leyenda'>
								<tr>
									<td class='leyenda_inicio' style='background-color:#3D8944; width:33%; color: white !important;'>Bosque/Forest</td>
									<td class='leyenda_inicio' style='background-color:#F4F4D8; width:33%;'>No Bosque/No Forest</td>
									<td class='leyenda_inicio' style='background-color:#FFA500; width:33%;'>Sin Información/No Data</td>
								</tr>
							</table>
						</div>			
<!-- 						<div class="puntoaparte"></div> -->
<!-- 						<div class="slide"> -->
<!-- 							<ul id="slippry-demo"> -->
<!-- 								<li><a href="#slide2"><img src="../img/cinta1.jpg" alt=""></a> <span class="caption"><h3></h3><p></p></span></li> -->
<!-- 								<li><a href="#slide3"><img src="../img/cinta2.jpg" alt=""></a> <span class="caption"><h3></h3><p></p></span></li> -->
<!-- 								<li><a href="#slide1"><img src="../img/cinta3.jpg" alt=""></a> <span class="caption"><h3></h3><p></p></span></li> -->
<!-- 								<li><a href="#slide2"><img src="../img/cinta4.jpg" alt=""></a> <span class="caption"><h3></h3><p></p></span></li> -->
<!-- 								<li><a href="#slide3"><img src="../img/cinta5.jpg" alt=""></a> <span class="caption"><h3></h3><p></p></span></li> -->
<!-- 								<li><a href="#slide3"><img src="../img/cinta6.jpg" alt=""></a> <span class="caption"><h3></h3><p></p></span></li> -->
<!-- 							</ul> -->
<!-- 						</div> -->
			...
			<%=UI.getMainIndex(usuario, sesion, msj, diccionarioPermisos, i18n)%>
