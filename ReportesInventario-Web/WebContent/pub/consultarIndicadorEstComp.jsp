...
<head>
<meta charset="utf-8" />
<title>Consultar reporte de indicadores de estructura y composici&oacute;n</title>
...
String token=r.connect("C:/Users/Usuario/Desktop/Analisis R nuevo/Estimacion parcela");
r.ejecutar(token, "a=3/4");
r.ejecutar(token,"a");*/
...
<script type="text/javascript">
	...
	function verificarCampos() {
		...
		if (document.getElementById("tBosqueAux").value == "-1") {
			mensaje = mensaje + "- Tipo de Bosque/Forest type";
			passed = false;
		}																
				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja">Cálculo de Estructura y Composición/Structure and Composition Calculation</h2>
								...
								$(function() {
									...
									$("#especieAux")
									    ...
									    source: function(request, response) {
										    $.ajax({
											    url: "especies.jsp?especieAux="+extractLast($("#especieAux").val()),
											    type: "POST",
											    dataType: "json",
									...
									<div id="block-consulta-reportes" class="block-gray block">
										...
										<h2>Búsqueda/Search</h2>
											<div class="form-group"
												...
												<label >Departamentos/Departments: </label>
												<div class="select-wrapper" style="max-width: 400px;">
													<select name="deptosAux" id="deptosAux">
													<option value="-1">Seleccionar/Select</option>
													<%=departamentos%>	</select>												
												</div>
											</div>
											<div class="form-group"
												style="padding-left: 20px; padding-right: 20px">
												<label >Tipos de Bosque/Forest types: </label>
												<div class="select-wrapper" style="max-width: 400px;">
													<select name="tBosqueAux" id="tBosqueAux">
													<option value="-1">Seleccionar/Select</option>
													<%=tipoBosque%>	</select>												
												</div>
											</div>
...
// 									                },$.datepicker.regional["es"]);
												    ...
												    $("#enviarConsulta").click(function(){
														...
														document.getElementById("tBosque").value= "";
														...
														document.getElementById("tBosque").value = document.getElementById("tBosqueAux").value;
														document.getElementById("depto").value = document.getElementById("deptosAux").value;
														...
														var data = {
																tBosque: document.getElementById("tBosqueAux").value,
																deptosAux: document.getElementById("deptosAux").value,
														...
														var url = "<%=basePath%>consultarReporteEstCompServlet";
	...
	<form action="<%=basePath%>consultarReporteEstCompServlet" method="post" name="formConsultaReporte" id="formConsultaReporte" onsubmit= "verificarCampos();">
			<input type="hidden" name="treporte" id="tBosque" value="">
			<input type="hidden" name="especie" id="especie" value="">
			<input type="hidden" name="pparcela" id="depto" value="">
