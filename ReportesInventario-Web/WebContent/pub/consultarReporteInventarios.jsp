				...
				<div id="main-inner" class="section-wrapper">
					<div class="section">
						<div class="section-inner clearfix fondoformulario">
							...
							<h2 class="titulo_naranja">Reporte de Inventario de Especies/Species Inventory Report</h2>
										...
										<h2>Búsqueda/Search</h2>
											<div class="form-group"
												...
												<div class="select-wrapper" style="max-width: 400px;">
													<input name="especieAux" id="especieAux" type="text" placeholder="Ingrese minimo 3 caracteres/At least 3 characters" required/>														
												</div>
											</div>
											...
											<div class="form-group item-periodos"
												...
												<span class="item-periodo-left" style="padding-left: 20px; padding-right: 20px"> 
													...
													<input type="text" class="select-wrapper" name="fechaIniAux" id="fechaIniAux" style="width:260px" required/>
													<script type='text/javascript'>
													Calendar.setup({
												...
												<span class="item-periodo-right" style="padding-left: 20px; padding-right: 20px"> 
													...
													<input type="text" class="select-wrapper" name="fechaFinAux" id="fechaFinAux" style="width:260px" required/>
													<script type='text/javascript'>
													Calendar.setup({
...
// 								                },$.datepicker.regional["es"]);
											    ...
											    $("#enviarConsulta").click(function(){
													...
													document.getElementById("pparcela").value= "";
												...
												//	document.getElementById("pparcela").value = document.getElementById("pparcelaAux").value;
	...
	<form action="<%=basePath%>consultarReporteServlet" method="post" name="formConsultaReporte" id="formConsultaReporte"onsubmit="return verificarCampos();">
			<input type="hidden" name="especie" id="especie" value="">
			<input type="hidden" name="pparcela" id="pparcela" value="">
