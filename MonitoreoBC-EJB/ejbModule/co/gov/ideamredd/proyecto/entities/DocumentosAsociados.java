...
/**
 * Clase que representa El documento asociado a un proyecto
 */
public class DocumentosAsociados {
	...
	private Timestamp una_FechaIngresoDocumento;
	...
	public Timestamp getUna_FechaIngresoDocumento() {
		return una_FechaIngresoDocumento;
	}

	public void setUna_FechaIngresoDocumento(Timestamp una_FechaIngresoDocumento) {
		this.una_FechaIngresoDocumento = una_FechaIngresoDocumento;
	}
