...
package co.gov.ideamredd.mbc.bosquecifras;
...
import co.gov.ideamredd.ejb.mbc.entities.BosqueArea;
import co.gov.ideamredd.ejb.mbc.entities.InfoCifras;
import co.gov.ideamredd.ejb.mbc.entities.InformacionReporteBiomasa;
import co.gov.ideamredd.ejb.mbc.entities.InformacionReporteBiomasaAreaHidro;
import co.gov.ideamredd.ejb.mbc.entities.InformacionReporteCobertura;
import co.gov.ideamredd.util.SMBC_Log;

@Stateless public class ConsultaBosqueCifras {
	...
	/**
	 * Método usado para consultar bosque no bosque por areas hidrograficas.
	 */
	public ArrayList<InfoCifras> consultarBosqNoBosqAreasHidro() {
		ArrayList<InfoCifras> cifrasAreasHid = new ArrayList<InfoCifras>();
		try {
			conn = conexion.establecerConexion();
			log = SMBC_Log.Log(ConsultaBosqueCifras.class);
			CallableStatement consultarCifras = conn.prepareCall("{call RED_PK_REPORTES.CONSULTARULTIMOREPOIBOSQUE(?,?)}");
			consultarCifras.setInt("UNA_DIVISION", 3);
			consultarCifras.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarCifras.execute();

			ResultSet resultSet = (ResultSet) consultarCifras.getObject("un_Resultado");
			...
			while (resultSet.next()) {
				...
				else if (resultSet.getString("INBS_NOMBRE").equals("Magdalena Cauca")) {
				...
				else if (resultSet.getString("INBS_NOMBRE").equals("Pacifico")) {
	...
	/**
	 * Método usado para consultar cifras de bosque consolidado.
	 */
	public ArrayList<Double> consultarPorcentCifrasConsolidado() {
	...
	/**
	 * Método usado para consultar cifras de Total Consolidado
	 */
	public ArrayList<Double> consultarCifrasConsolidado() {
		ArrayList<Double> cifrasConsolidado = new ArrayList<Double>();
		try {
			conn = conexion.establecerConexion();
			log = SMBC_Log.Log(ConsultaBosqueCifras.class);
	...
	/**
	 * Método usado para consultar informacion de consolidado, en biomasa.
	 */
	public ArrayList<InformacionReporteBiomasa> consultarInfoConsolidadoBiomasa() {
		...
		try {
			...
			CallableStatement consultarInfoBosque = conn.prepareCall("{call RED_PK_REPORTES.CONSULTAR_ULTI_INFOBIOMASA(?)}");
			consultarInfoBosque.registerOutParameter("UN_RESULTADO", OracleTypes.CURSOR);
			consultarInfoBosque.execute();
			ResultSet resultSet = (ResultSet) consultarInfoBosque.getObject("UN_RESULTADO");
			while (resultSet.next()) {
	...
	/**
	 * Método usado para consultar la informacioin de biomasa.
	 */
	public ArrayList<InformacionReporteBiomasaAreaHidro> consultarInfoBiomasa() {
		...
		try {
			...
			CallableStatement consultarInfoBosque = conn.prepareCall("{call RED_PK_REPORTES.CONSULTI_INFOBIOMASA_AREAH(?)}");
			consultarInfoBosque.registerOutParameter("UN_RESULTADO", OracleTypes.CURSOR);
			consultarInfoBosque.execute();
			ResultSet resultSet = (ResultSet) consultarInfoBosque.getObject("UN_RESULTADO");
			...
			while (resultSet.next()) {
				...
				if (resultSet.getString("Area_Hidrografica").equals("Amazonas")) {
					amazonas.bosques.add(new BosqueArea(resultSet.getString("Nombre_Bosque"), resultSet.getDouble("Area")));
				...
				else if (resultSet.getString("Area_Hidrografica").equals("Caribe")) {
					caribe.bosques.add(new BosqueArea(resultSet.getString("Nombre_Bosque"), resultSet.getDouble("Area")));
				...
				else if (resultSet.getString("Area_Hidrografica").equals("Orinoco")) {
					orinoco.bosques.add(new BosqueArea(resultSet.getString("Nombre_Bosque"), resultSet.getDouble("Area")));
				...
				else if (resultSet.getString("Area_Hidrografica").equals("Magdalena Cauca")) {
					magCauca.bosques.add(new BosqueArea(resultSet.getString("Nombre_Bosque"), resultSet.getDouble("Area")));
				...
				else if (resultSet.getString("Area_Hidrografica").equals("Pacifico")) {
					pacifico.bosques.add(new BosqueArea(resultSet.getString("Nombre_Bosque"), resultSet.getDouble("Area")));
	...
	/**
	 * Método usado para consultar cobeturas por area hidrografica.
	 */
	public ArrayList<InformacionReporteCobertura> consultarInfoCoberturaAH() {
		...
		try {
			...
			CallableStatement consultarInfoBosque = conn.prepareCall("{call RED_PK_REPORTES.CONSULTI_INFOCOBERTURA_AH(?)}");
			consultarInfoBosque.registerOutParameter("UN_RESULTADO", OracleTypes.CURSOR);
			consultarInfoBosque.execute();
			ResultSet resultSet = (ResultSet) consultarInfoBosque.getObject("UN_RESULTADO");
			...
			while (resultSet.next()) {
				...
				if (resultSet.getString("NOMBRE").equals("Amazonas")) {
					amazonas.setDeforestacion(resultSet.getBigDecimal("DEFOREST"));
					amazonas.setReforestacion(resultSet.getBigDecimal("REGENER"));
				}
					...
					orinoco.setDeforestacion(resultSet.getBigDecimal("DEFOREST"));
					orinoco.setReforestacion(resultSet.getBigDecimal("REGENER"));
				}
				else if (resultSet.getString("NOMBRE").equals("Magdalena Cauca")) {
					magCauca.setDeforestacion(resultSet.getBigDecimal("DEFOREST"));
					magCauca.setReforestacion(resultSet.getBigDecimal("REGENER"));
				}
				else if (resultSet.getString("NOMBRE").equals("Pacifico")) {
					pacifico.setDeforestacion(resultSet.getBigDecimal("DEFOREST"));
					pacifico.setReforestacion(resultSet.getBigDecimal("REGENER"));
				}
	...
	/**
	 * Método usado para consultar consolidado de coberturas.
	 */
	public ArrayList<InformacionReporteCobertura> consultarInfoCoberturaConsolidado() {
		...
		try {
			...
			CallableStatement consultarInfoBosque = conn.prepareCall("{call RED_PK_REPORTES.CONSULTAR_ULTI_INFOCOBERTURA(?)}");
			consultarInfoBosque.registerOutParameter("UN_RESULTADO", OracleTypes.CURSOR);
			consultarInfoBosque.execute();
			ResultSet resultSet = (ResultSet) consultarInfoBosque.getObject("UN_RESULTADO");
			while (resultSet.next()) {
	...
	/**
	 * Método usado para listar las areas de bosque.
	 */
	public ArrayList<BosqueArea> listaBosqueArea(ArrayList<InformacionReporteBiomasa> datos) {
	...
	/**
	 * Método usado para consultar areas hidrograficas.
	 */
	public void consultarAreaHidrografica() {
		...
		try {
			...
			ResultSet resultSet = (ResultSet) consultarAreaH.getObject("UN_RESULTADO");
	...
	/**
	 * Método usado para limitar numero de decimales de los resultados.
	 */
