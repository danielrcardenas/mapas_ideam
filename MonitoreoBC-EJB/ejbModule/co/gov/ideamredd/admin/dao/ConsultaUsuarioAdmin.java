...
import co.gov.ideamredd.admin.security.Encript;
...
@Stateless public class ConsultaUsuarioAdmin {
	...
	private String	un_Rol				= "";
	private Integer	un_idRol			= -1;
	private Integer	un_activo			= -1;
	private Integer	un_tipo				= -1;
	// private ArrayList<Usuario> usuarios;
	private String	un_CorreoElectronico;

	/**
	 * Metodo usado para consultar usuarios registrados.
	 */
	public ArrayList<Usuario> consultaExtendidaUsuarios() {
		ArrayList<Usuario> usuarios = new ArrayList<Usuario>();
		Usuario usuario = null;
		try {
			log = SMBC_Log.Log(ConsultaUsuarioAdmin.class);
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarUsuario = conn.prepareCall("{call RED_PK_USUARIOS.Usuario_Consulta_Extendida(?,?,?,?,?,?,?,?)}");
			consultarUsuario.setString("una_Identificacion", una_Identificacion);
			consultarUsuario.setString("un_Nombre", un_Nombre.toUpperCase());
			consultarUsuario.setInt("un_TipoDocumento", un_TipoDocumento);
			consultarUsuario.setInt("un_idRol", un_idRol);
			consultarUsuario.setInt("un_activo", un_activo);
			consultarUsuario.setInt("un_tipo", un_tipo);
			consultarUsuario.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarUsuario.registerOutParameter("un_Mensaje", OracleTypes.VARCHAR, 250);
			...
			while (resultSet.next()) {
				...
				if (resultSet.getString("USR_CONS_PAIS") != null) {
					usuario.setPais(resultSet.getInt("USR_CONS_PAIS"));
					usuario.setNombrePais(consultaNombrePais(resultSet.getInt("USR_CONS_PAIS")));
				}
				usuario.setTipoPersona(resultSet.getInt("USR_CONS_TIPOPERSONA"));
				usuario.setNombreTipoPersona(consultaNombreTipoPersona(resultSet.getInt("USR_CONS_TIPOPERSONA")));
				usuario.setTipoIdentificacion(Auxiliar.nzObjInt(resultSet.getInt("USR_CONS_TIPOIDENT"), 0));
				usuario.setNombreTipoIdenti(consultaNombreTipoIdent(resultSet.getInt("USR_CONS_TIPOIDENT")));
				usuario.setDireccion(resultSet.getString("USR_DIRECCION"));
				usuario.setTelefonoOficina(Auxiliar.nzObjStr(resultSet.getString("USR_TELEFONO"), ""));
				...
				if (resultSet.getString("USR_DEPTO") != null) {
					...
					usuario.setNombreDepto(consultaNombreDepartamento(resultSet.getInt("USR_DEPTO")));
				}
				if (resultSet.getString("USR_MUNICIPIO") != null) {
					usuario.setMunicipio(resultSet.getInt("USR_MUNICIPIO"));
					usuario.setNombreCiudad(consultaNombreMunicipio(resultSet.getInt("USR_MUNICIPIO")));
				}
				...
				Integer idRol = consultarIdRol(resultSet.getInt("USR_CONSECUTIVO"));
				if (idRol != null) {
					usuario.setRolId(idRol);
					String nombreRol = consultarNombreRol(idRol);
					ArrayList<String> nombresRol = new ArrayList<String>();
					nombresRol.add(nombreRol);
					usuario.setRolNombre(nombresRol);
				}
				usuario.setNombresLicencias(consultarNombresLicencias(resultSet.getInt("USR_CONSECUTIVO")));
	...
	public String consultarNombreRol(Integer idRol) {
		String nombreRol = "";

		if (idRol == null) return "";

		try {
			nombreRol = ConexionBD.obtenerDato("SELECT ROL_NOMBRE FROM RED_ROL WHERE ROL_CONSECUTIVO=" + idRol, "", null);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	/**
	 * Método usado para consultar usuarios registrados.
	 */
	public ArrayList<Usuario> consultarUsuario() {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarUsuario = conn.prepareCall("{call RED_PK_USUARIOS.Usuario_Consulta(?,?,?,?,?,?)}");
			consultarUsuario.setString("una_Identificacion", una_Identificacion);
			consultarUsuario.setString("un_Nombre", un_Nombre.toUpperCase());
			consultarUsuario.setInt("un_TipoDocumento", un_TipoDocumento);
			...
			while (resultSet.next()) {
				...
				if (resultSet.getString(7) != null) {
					...
					usuario.setNombrePais(consultaNombrePais(resultSet.getInt(7)));
				}
				usuario.setTipoPersona(resultSet.getInt(8));
				usuario.setNombreTipoPersona(consultaNombreTipoPersona(resultSet.getInt(8)));
				usuario.setTipoIdentificacion(resultSet.getInt(9));
				usuario.setNombreTipoIdenti(consultaNombreTipoIdent(resultSet.getInt(9)));
				...
				if (resultSet.getString(16) != null) {
					...
					usuario.setNombreDepto(consultaNombreDepartamento(resultSet.getInt(16)));
				}
				if (resultSet.getString(17) != null) {
					usuario.setMunicipio(resultSet.getInt(17));
					usuario.setNombreCiudad(consultaNombreMunicipio(resultSet.getInt(17)));
				}
				...
				usuario.setNombresLicencias(consultarNombresLicencias(resultSet.getInt(1)));
	...
	/**
	 * Método usado para consultar notificaciones a usuarios.
	 */
	public Usuario consultarUsuarioRecordatorio() {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarUsuario = conn.prepareCall("{call RED_PK_USUARIOS.Usuario_Consulta_Recordatorio(?,?,?)}");
			consultarUsuario.setString("un_CorreoElectronico", un_CorreoElectronico);
			consultarUsuario.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
	...
	public Usuario consultarUsuarioPorLogin(String login) {
		Usuario usuario = UtilWeb.consultarUsuarioPorLogin(login);
		return usuario;
	}

	/**
	 * Método usado para consultar un usuario.
	 */
	...
	/**
	 * Método para confirmar que el ingreso de usuario fue correcto.
	 */
	public Usuario usuarioEnLogOnCorrecto(int docPersona, String password) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarUsuario = conn.prepareCall("{call RED_PK_USUARIOS.USUARIOLOGON(?,?,?)}");
			consultarUsuario.setInt("un_Doc", docPersona);
			consultarUsuario.setString("un_Pass", Encript.getEncodedPassword(password));
			consultarUsuario.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarUsuario.execute();
			ResultSet resultSet = (ResultSet) consultarUsuario.getObject("un_Resultado");
	...
	public Usuario consultarUsuario(int idPersona) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarUsuario = conn.prepareCall("{call RED_PK_USUARIOS.Usuario_Consulta_Id(?,?,?)}");
			...
			while (resultSet.next()) {
				...
				usuario.setTipoIdentificacion(Integer.valueOf(resultSet.getObject(10).toString()));
	...
	/**
	 * Método para consultar el ultimo ingreso de un usuario.
	 */
	...
	/**
	 * Método para consultar las estadisticas de los usuarios registrados.
	 */
	public ArrayList<Object> consultarEstadisticasTiposPersona(String fechaIni, String fechaFin) {
		ArrayList<Object> estadistica = null;
		try {
			log = SMBC_Log.Log(ConsultaUsuarioAdmin.class);
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarEstadisticas2 = conn.prepareCall("{call RED_PK_USUARIOS.UsuarioEstadistica2_Consulta(?,?,?,?)}");
			consultarEstadisticas2.setString("una_fechaini", fechaIni);
			consultarEstadisticas2.setString("una_fechafin", fechaFin);
			consultarEstadisticas2.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarEstadisticas2.registerOutParameter("sentencia1", OracleTypes.VARCHAR);
			consultarEstadisticas2.execute();

			ResultSet resultSet2 = (ResultSet) consultarEstadisticas2.getObject("un_Resultado");
			estadistica = new ArrayList<Object>();

			while (resultSet2.next()) {
				String[] datos = { resultSet2.getString(1), resultSet2.getString(2) };
	...
	/**
	 * Método para consultar las estadisticas de los usuarios registrados. por departamento.
	 */
	public ArrayList<Object> consultarEstadisticasDepartamentos(String fechaIni, String fechaFin) {
		ArrayList<Object> estadistica = null;
		try {
			log = SMBC_Log.Log(ConsultaUsuarioAdmin.class);
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarEstadisticas3 = conn.prepareCall("{call RED_PK_USUARIOS.UsuarioEstadisticaDeptos(?,?,?,?)}");
			consultarEstadisticas3.setString("una_fechaini", fechaIni);
			consultarEstadisticas3.setString("una_fechafin", fechaFin);
			consultarEstadisticas3.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarEstadisticas3.registerOutParameter("un_Mensaje", OracleTypes.VARCHAR);
			consultarEstadisticas3.execute();
			System.out.println(consultarEstadisticas3.getObject("un_Mensaje"));
			ResultSet resultSet3 = (ResultSet) consultarEstadisticas3.getObject("un_Resultado");
			estadistica = new ArrayList<Object>();
	...
	/**
	 * Método para consultar el total de estadisticas.
	 */
	public ArrayList<Integer> consultarEstadisticasTotales(String fechaIni, String fechaFin) {
		ArrayList<Integer> estadistica = new ArrayList<Integer>();
		try {
			log = SMBC_Log.Log(ConsultaUsuarioAdmin.class);
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarEstadisticas3 = conn.prepareCall("{call RED_PK_USUARIOS.UsuarioEstadisticaTotales(?,?,?,?)}");
			consultarEstadisticas3.setString("una_fechaini", fechaIni);
			consultarEstadisticas3.setString("una_fechafin", fechaFin);
			consultarEstadisticas3.registerOutParameter("UN_TOLTAL", OracleTypes.CURSOR);
			consultarEstadisticas3.registerOutParameter("UN_ToltalPub", OracleTypes.CURSOR);
			consultarEstadisticas3.execute();
			ResultSet resultSet3 = (ResultSet) consultarEstadisticas3.getObject("UN_TOLTAL");

			resultSet3.next();
			estadistica.add(resultSet3.getInt(1));

			resultSet3 = (ResultSet) consultarEstadisticas3.getObject("UN_ToltalPub");
	...
	/**
	 * Método para consultar las estadisticas de usuarios por tipo de persona.
	 */
	public ArrayList<Object> consultarEstadisticaUsuariosXTipoPersona(String fechaIni, String fechaFin) {
		ArrayList<Object> estadistica = null;
		try {
			log = SMBC_Log.Log(ConsultaUsuarioAdmin.class);
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaXTipoPersona = conn.prepareCall("{call RED_PK_USUARIOS.UsuariosXEstadistica2_Consulta(?,?,?)}");
			consultaXTipoPersona.setString("una_fechaini", fechaIni);
			consultaXTipoPersona.setString("una_fechafin", fechaFin);
			consultaXTipoPersona.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultaXTipoPersona.execute();

			ResultSet resultSet = (ResultSet) consultaXTipoPersona.getObject("un_Resultado");
			estadistica = new ArrayList<Object>();

			while (resultSet.next()) {
				String[] datos = { resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getString(4), resultSet.getString(5), resultSet.getString(6) };
				estadistica.add(datos);
			}
			resultSet.close();
	...
	/**
	 * Método para consultar las estadisticas de usuarios por departamento.
	 */
	public ArrayList<Object> consultarEstadisticaUsuariosXDepartamentos(String fechaIni, String fechaFin) {
		ArrayList<Object> estadistica = null;
		try {
			log = SMBC_Log.Log(ConsultaUsuarioAdmin.class);
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaXDepartamentos = conn.prepareCall("{call RED_PK_USUARIOS.UsuarioEstadisticaDeptos(?,?,?)}");
			consultaXDepartamentos.setString("una_fechaini", fechaIni);
			consultaXDepartamentos.setString("una_fechafin", fechaFin);
			consultaXDepartamentos.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultaXDepartamentos.execute();

			ResultSet resultSet = (ResultSet) consultaXDepartamentos.getObject("un_Resultado");
			estadistica = new ArrayList<Object>();
	...
	/**
	 * Método para consultar el id de un rol por un id de usuario.
	 */
	public Integer consultarIdRol(int idUsuario) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarIdRol = conn.prepareCall("{call RED_PK_USUARIOS.Consulta_IDRol(?,?)}");
			consultarIdRol.setInt("un_IdUsuario", idUsuario);
			consultarIdRol.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarIdRol.execute();

			ResultSet resultSet = (ResultSet) consultarIdRol.getObject("un_Resultado");
	...
	/**
	 * Método para consultar el nombre del tipo persona usando su id.
	 */
	public String consultaNombreTipoPersona(int idTipoPers) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaNombre = conn.prepareCall("{call RED_PK_TABLASTIPO.TipoPersona_idConsulta(?,?)}");
			consultaNombre.setInt("un_Tipo", idTipoPers);
			consultaNombre.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultaNombre.execute();

			ResultSet resultSet = (ResultSet) consultaNombre.getObject("un_Resultado");
	...
	/**
	 * Método para consultar el tipo de identificacion por su id.
	 */
	public String consultaNombreTipoIdent(int idTipoIdent) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaNombre = conn.prepareCall("{call RED_PK_TABLASTIPO.TipoIdentificacion_IdConsulta(?,?)}");
	...
	/**
	 * Método para consultar el nombre de un pais por su id.
	 */
	public String consultaNombrePais(int idPais) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaNombre = conn.prepareCall("{call RED_PK_USUARIOS.PaisPersona_Consulta(?,?)}");
	...
	/**
	 * Método para consultar el nombre de un departamento por su id.
	 */
	public String consultaNombreDepartamento(int idDepto) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaNombre = conn.prepareCall("{call RED_PK_USUARIOS.DeptoPersona_Consulta(?,?)}");
	...
	/**
	 * Método para consultar el nhombre de un municipio por su id.
	 */
	public String consultaNombreMunicipio(int idMuni) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultaNombre = conn.prepareCall("{call RED_PK_USUARIOS.MunicipioPersona_Consulta(?,?)}");
	...
	/**
	 * Método para consultar los nombres de las licencias de un usuario.
	 */
	public String consultarNombresLicencias(int idPersona) {
		...
		try {
			...
			// conn = conexion.establecerConexion();
			Connection conn = ConexionBD.establecerConexion();
			CallableStatement consultarUsuario = conn.prepareCall("{call RED_PK_USUARIOS.Usuario_Consulta_Licencias(?,?)}");
			consultarUsuario.setInt("un_Id", idPersona);
			consultarUsuario.registerOutParameter("un_Resultado", OracleTypes.CURSOR);
			consultarUsuario.execute();
			ResultSet resultSet = (ResultSet) consultarUsuario.getObject("un_Resultado");
	...
	public Integer getUn_idRol() {
		return un_idRol;
	}

	public void setUn_idRol(Integer un_idRol) {
		this.un_idRol = un_idRol;
	}

	public Integer getUn_activo() {
		return un_activo;
	}

	public void setUn_activo(Integer un_activo) {
		this.un_activo = un_activo;
	}

	public Integer getUn_tipo() {
		return un_tipo;
	}

	public void setUn_tipo(Integer un_tipo) {
		this.un_tipo = un_tipo;
	}
