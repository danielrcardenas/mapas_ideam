...
/**
 * Bean para consultar usuario
 */
@Stateless public class ConsultaUsuario_Usuario {
...
//			consultarUsuario.setInt("una_Identificacion", una_Identificacion.intValue());
...
//				}
				...
				usuario.setTelefonoOficina(resultSet.getObject("USR_TELEFONO").toString());
	...
	/**
	 * Metodo para consultar el recordatorio de un usuario.
	 */
...
//			conn = conexion.establecerConexion();
			...
			while (resultSet.next()) {
				...
				usuario.setTipoIdentificacion(resultSet.getInt("USR_CONS_TIPOIDENT"));
				usuario.setDireccion(resultSet.getString("USR_DIRECCION"));
				usuario.setTelefonoOficina(Auxiliar.nzObjStr(resultSet.getObject("USR_TELEFONO"), "").toString());
				if (resultSet.getString("USR_MOVIL") != null) {
					usuario.setCelular(resultSet.getString("USR_MOVIL"));
				}
				usuario.setClave(resultSet.getString("USR_CLAVE"));
	...
	/**
	 * Metodo para consultar un usuario por su documento.
	 */
...
//				}
	...
	public Usuario usuarioEnLogOnCorrecto(String docPersona, String password) {
		Usuario usuario = null;
		/*
		 * try { log = SMBC_Log.Log(ConsultaUsuario_Usuario.class); conn = conexion.establecerConexion(); CallableStatement consultarUsuario = conn .prepareCall("{call RED_PK_USUARIOS.USUARIOLOGON(?,?,?)}"); //consultarUsuario.setInt("un_Doc",
		 * docPersona); consultarUsuario.setString("un_Doc", docPersona); consultarUsuario.setString("un_Pass", Encript.getEncodedPassword(password)); consultarUsuario.registerOutParameter("un_Resultado", OracleTypes.CURSOR); consultarUsuario.execute();
		 * ResultSet resultSet = (ResultSet) consultarUsuario .getObject("un_Resultado");
		 * 
		 * while (resultSet.next()) { usuario = new Usuario(); usuario.setIdUsuario(resultSet.getInt(1)); usuario.setNombre(resultSet.getString(2)); usuario.setIdentificacion(resultSet.getObject(3).toString());
		 * usuario.setCorreoElectronico(resultSet.getString(4)); usuario.setFechaCreacion(resultSet.getString(5)); usuario.setActivo(resultSet.getString(6)); usuario.setPais(resultSet.getInt(7)); usuario.setTipoPersona(resultSet.getInt(8));
		 * usuario.setTipoIdentificacion(resultSet.getInt(9)); usuario.setDireccion(resultSet.getString(10)); usuario.setTelefonoOficina(resultSet.getObject(11).toString()); if (resultSet.getString(12) != null) {
		 * usuario.setCelular(resultSet.getString(12)); } usuario.setClave(resultSet.getString(13)); if (resultSet.getString(14) != null) { usuario.setApellidoUno(resultSet.getString(14)); } if (resultSet.getString(15) != null) {
		 * usuario.setApellidoDos(resultSet.getString(15)); } if (resultSet.getString(16) != null) { usuario.setDepto(resultSet.getInt(16)); } if (resultSet.getString(17) != null) { usuario.setMunicipio(resultSet.getInt(17)); } if (resultSet.getString(18)
		 * != null) { usuario.setOrganizacion(resultSet.getString(18)); } if (resultSet.getString(19) != null) { usuario.setCargo(resultSet.getString(19)); } }
		 * 
		 * resultSet.close(); consultarUsuario.close(); conn.close(); log.info("[usuarioEnLogOnCorrecto] Termino"); } catch (Exception e) { log.error("[usuarioEnLogOnCorrecto] Fallo"); e.printStackTrace(); }
		 */
		return usuario;
	}
...
//				usuario.setCargo(resultSet.getString(19));
	...
	/**
	 * Metodo para consultar el ultimo ingreso de un usuario.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para las estaditicas de usuarios, por tipo de persona.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar las estadisticas de usuarios por departamento.
	 */
...
//			conn = conexion.establecerConexion();
			...
			while (resultSet3.next()) {
				...
				if (resultSet3.getString(2) != null) {
	...
	/**
	 * Metodo para consultar estadisticas totales de usuarios.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar estadisticas de usuario por tipo de persona.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar estadisticas de usuarios por departamentos.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar el id de rol de un usuario.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar el nombre de un tipo de persona.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar nombre por tipo de identificacion.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar nombre de un pais.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar nombre de un departamento.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar nombre de un municipio.
	 */
...
//			conn = conexion.establecerConexion();
	...
	/**
	 * Metodo para consultar nombres de licencias.
	 */
