...
function init(){
    ...
    var bounds = new OpenLayers.Bounds(
        498223.006960941, 42740.4375116992,
        1750620.5629883, 1740185.349
    );
    var options = {
        controls: [],
        maxExtent: bounds,
        maxResolution: 6630.644185501174,
    ...
    tiled = new OpenLayers.Layer.WMS(
        "OracleAmazon:PARCELAS_AREA - Tiled", "http://54.172.131.5:8080/geoserver/OracleAmazon/wms",
        {
            "LAYERS": 'OracleAmazon:PARCELAS_AREA',
            "STYLES": '',
            format: format
        },
        {
    ...
    untiled = new OpenLayers.Layer.WMS(
        "OracleAmazon:PARCELAS_AREA - Untiled", "http://54.172.131.5:8080/geoserver/OracleAmazon/wms",
        {
            "LAYERS": 'OracleAmazon:PARCELAS_AREA',
            "STYLES": '',
            format: format
