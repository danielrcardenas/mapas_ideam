...
<title>
<% try { out.print(msj.getString(yo+"Procesar_Archivo")); } catch (MissingResourceException e) { out.print("Procesar Archivo" + ".."); } %> 
</title>
...
try {
	...
	if (!id_usuario.equals("")) {
		menu = sec.generarMenu(id_usuario, "menu_carguemasivo.jsp", idioma);
	}
}
catch (Exception e) {
	menu = "..." + e.toString();
...
<h1>
<% try { out.print(msj.getString(yo+"Resultados_de_la_Importacion_del_Archivo")); } catch (MissingResourceException e) { out.print("Resultados de la Importación del Archivo" + ".."); } %> 
:</h1>
