...
String yo = "log_importacion_archivo_individuos.";
...
<title>
<% try { out.print(msj.getString(yo+"Log_de_Errores_de_Importacion")); } catch (MissingResourceException e) { out.print("Log de Errores de Importación" + ".."); } %> 
</title>
...
<h1>
<% try { out.print(msj.getString(yo+"Errores_de_Importacion_de_Individuos")); } catch (MissingResourceException e) { out.print("Errores de Importación de Individuos" + ".."); } %> 
:</h1>
