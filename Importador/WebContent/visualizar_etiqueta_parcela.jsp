...
String yo = "visualizar_etiqueta_parcela.";
...
<h1>
<% 
try { out.print(msj.getString(yo+"Titulo_Parcela")); } catch (MissingResourceException e) { out.print("Parcela "); } 
out.print(Auxiliar.nzObjStr(request.getAttribute("PRCL_CONSECUTIVO"), "").toString());
%>
</h1>
...
if (Auxiliar.tieneAlgo(PRCL_CONSECUTIVO)) {
	String url_imagenes = "ImagenesParcela?accion=imagenes_parcela&solovisor=1&control=&PRCL_CONSECUTIVO=" + PRCL_CONSECUTIVO; 
%>
<div class="iframe_subformulario_imagenes_etiquetas">
<iframe class="iframe_subformulario_imagenes_etiquetas" id="iframe_imagenes" src="<%= url_imagenes %>"></iframe>
</div>
<% } %>

<div class="div_metadatos_etiqueta">
<% 
