...
<title>
<% try { out.print(msj.getString(yo+"Eliminar_Archivo")); } catch (MissingResourceException e) { out.print("Eliminar Archivo" + ".."); } %> 
</title>
</head>
<body>
...
<h1>
<% try { out.print(msj.getString(yo+"Resultados_de_la_Eliminacion_del_Archivo")); } catch (MissingResourceException e) { out.print("Resultados de la Eliminación del Archivo" + ".."); } %> 
:</h1>
...
<p><a href='menu.jsp?usuario=<% out.print(request.getParameter("usuario"));%>&idioma=<% out.print(request.getParameter("idioma"));%>'>
<% try { out.print(msj.getString("General.Menu_CargueMasivo")); } catch (MissingResourceException e) { out.print("Menú Cargue Masivo" + ".."); } %> 
</a></p>
