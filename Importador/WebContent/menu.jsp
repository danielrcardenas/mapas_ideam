...
<title>
<% try { out.print(msj.getString("General.Menu_Principal")); } catch (MissingResourceException e) { out.print("Administración de Inventarios Forestales" + ".."); } %> 
</title>
...
$(document).ready(function(){
    ...
    //alert(getWidth() + ' vs ' + $(window).width());
    //document.body.style.width = $(window).width() + 'px';
    <% } %>
});
...
try {
	...
	if (!id_usuario.equals("")) {
		menu = sec.generarMenu(id_usuario, "menu.jsp", idioma);
	}
}
catch (Exception e) {
	menu = "..." + e.toString();
...
<a class=boton href='Parcela?accion=busqueda_parcelas'>
<% try { out.print(msj.getString("General.Administrar_Parcelas_e_Individuos")); } catch (MissingResourceException e) { out.print("Parcelas e Individuos" + ".."); } %> 
</a>
</div>

<!-- 
<div class=opcionmenu>
<a class=boton href='busqueda_individuos.jsp'>
<% // try { out.print(msj.getString("General.Administrar_Individuos")); } catch (MissingResourceException e) { out.print("Administrar Individuos" + ".."); } %> 
</a>
</div>
-->

<div class=opcionmenu>
<a class=boton href='menu_carguemasivo.jsp'>
<% try { out.print(msj.getString("General.Menu_CargueMasivo")); } catch (MissingResourceException e) { out.print("Cargue Masivo de Inventarios Forestales" + ".."); } %> 
</a>
</div>
