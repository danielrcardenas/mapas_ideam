...
<link type="text/css" rel="stylesheet" href="/AdmIF/css/estilos.css" media="all" />
<link type="text/css" rel="stylesheet" href="/AdmIF/css/<% out.print(estilo); %>" media="all" />
 
<title>
<% try { out.print(msj.getString("pagina_no_encontrada")); } catch (MissingResourceException e) { out.print("Lo sentimos, página no encontrada u opción no disponible." + ".."); } %> 
</title>
</head>
<body>
...
<% 
out.println(Auxiliar.nzObjStr(request.getAttribute("retorno"), "")); 
%>

<div class="opcionmenu">
<a href='/AdmIF'>
<% try { out.print(msj.getString("home.home")); } catch (MissingResourceException e) { out.print("Página de inicio" + ".."); } %> 
</a>
</div>
