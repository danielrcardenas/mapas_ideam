...
<title>Login al Sistema de Administración de Inventarios Forestales</title>
...
<form name=f action='Parcela?accion=busqueda_parcelas' method='POST'>				
...
<select name="idioma"><option value="es" selected>Español</option><option value="en">English</option></select>
</div>
