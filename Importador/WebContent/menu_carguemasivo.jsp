...
<a class=boton href='registro_archivo.jsp'>
<% try { out.print(msj.getString("General.Subir_Archivos")); } catch (MissingResourceException e) { out.print("Subir Archivos" + ".."); } %> 
</a>
</div>

<div class=opcionmenu>
<a class=boton href='consulta_archivos.jsp'>
<% try { out.print(msj.getString("General.Ver_Archivos")); } catch (MissingResourceException e) { out.print("Ver Archivos" + ".."); } %> 
</a>
</div>
