...
String yo = "log_importacion_archivo_tallos.";
...
<h1>
<% try { out.print(msj.getString(yo+"Errores_de_Importacion_de_Tallos")); } catch (MissingResourceException e) { out.print("Log de Importación de Tallos" + ".."); } %> 
:</h1>
