...
<%}%>
	...
	function enviarFormularioReporte()
	{
	    ...
	    {
			setTimeout(function(){document.location.href = '<%=basePath2%>'+"ReportesMonitoreo-Web/pub/consultarReporteCarbono.jsp"},500);
		    
<%-- 			location.href = '<%=basePath2%>'+"ReportesMonitoreo-Web/pub/consultarReporteCarbono.jsp"; --%>
			return;
		}
