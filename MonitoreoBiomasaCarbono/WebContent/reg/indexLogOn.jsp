...
<% 
	...
	Usuario usuario = UtilWeb.consultarUsuarioPorDoc(Integer
			...
			<div id="header">
					...
					<div class="section">
						<div class="section-inner clearfix">
							...
							<div id="block-logo" class="block">
								<div class="content">
									<a href="<%=basePath2%>MonitoreoBC-WEB/home.jsp"><img src="../img/logo.png" alt=""></a>
								</div>
								<!-- /.content -->
							</div>
							<!-- /.block -->
				...
				<div id="header-second" class="section-wrapper">
					<div class="section">
						...
						<!-- Fin menu verde cuando el usuario esta en Log in -->
								<div class="content">
									<ul class="main-menu item-list">
										<li class="menu-item home expanded"><a><%=msj.getString("home.carbono")%></a>
											<ul class="menu">
												<li class="first leaf"><a href="<%=basePath2%>Proyectos-Web/pub/consultaProyecto.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>"><%=msj.getString("home.carbono.actividades")%></a></li>
												<li class="leaf"><a href="<%=basePath2%>/ReportesMonitoreo-Web/pub/consultarReporteCarbono.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>"><%=msj.getString("home.carbono.reportes")%></a></li>
<%-- 												<li class="leaf"><a href="<%=basePath2%>/Parcelas-Web/pub/consultarParcela.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>"><%=msj.getString("home.carbono.estimacion")%></a></li> --%>
											</ul></li>                        
...
<%-- 												<li class="first leaf"><a><%=msj.getString("home.bosques.ifn")%></a></li> --%>
												<li class="leaf"><a href="<%=basePath2%>/ReportesMonitoreo-Web/pub/consultarReporteBosques.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>"><%=msj.getString("home.bosques.cuantificacion")%></a></li>
<%-- 												<li class="leaf"><a><%=msj.getString("home.bosques.alertas")%></a></li> --%>
												<li class="leaf"><a href="<%=basePath2%>AdmIF/menu.jsp?usuario=<%=Util.encriptar(usuario.getIdentificacion())%>&idioma=<%=i18n.getLenguaje()%>">Administracion de inventarios forestales</a></li>
											</ul>
										</li>
...
<%-- 											    href="<%=basePath2%>MonitoreoBC-WEB/verNoticiasYEventos.jsp">Consultar Noticias y Eventos</a></li> --%>
<!-- 											    <li class="menu-item noticia"><a -->
...
<!--  									        </ul> -->
										...
										<%
											if (usuario.getRolNombre().contains("ADMINISTRADOR_GENERAL")) {
										%>
										<li class="menu-item contact-us expanded"><a>Administar</a>
											<ul class="menu">
												<li class="first leaf"><a href="<%=basePath2%>Usuarios_Web/admin/consultarUsuarios.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>"><%=msj.getString("logOn.admin.consultarUsuarios")%></a></li>
												<li class="leaf"><a href="<%=basePath2%>Usuarios_Web/admin/generarReportesUsuarios.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>"><%=msj.getString("logOn.admin.reporteUsuarios")%></a></li>
<%-- 												<li class="leaf"><a href="<%=basePath2%>Parametrizacion_Web/reg/home.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>">Parametros</a></li> --%>
												<li class="leaf"><a href="<%=basePath2%>Descarga_WEB/reg/home.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>">Descarga de Imagenes</a></li>
												<li class="leaf"><a href="<%=basePath2%>Descarga_WEB/reg/home1.jsp?id=<%=Util.encriptar(usuario.getIdentificacion())%>&idiom=<%=i18n.getLenguaje()%>&pais=<%=i18n.getPais()%>">Inventario de Imagenes</a></li>
												<li class="leaf"><a href="<%=basePath2%>MonitoreoBC-WEB/borrarArchivosServlet"><%=msj.getString("logOn.admin.borrarTemporales")%></a></li>  
											</ul>
										</li>
										<%}else{ %>	
...
<!-- 							</div> -->
	...
	<form method="post" action="j_security_check" name="j_security_check"
		id="j_security_check">
		<input type="hidden" name="j_username" id="j_username" /> <br>
