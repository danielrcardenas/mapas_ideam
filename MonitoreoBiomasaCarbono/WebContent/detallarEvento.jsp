...
<%
	...
	String indice = request.getParameter("e");
	ArrayList<Noticias> noticias = (ArrayList<Noticias>) request.getSession()
	.getAttribute("noticia");
	ArrayList<Noticias> eventos = (ArrayList<Noticias>) request.getSession()
	.getAttribute("eventos");
	Noticias e1 = eventos.get(Integer.valueOf(indice));
...
<script type="text/javascript">
    ...
    function lenguaje(id){
		...
		document.getElementById('pagina').value="<%=request.getRequestURI()%>?e=<%=indice%>";
								...
								<div class="content-inner">
									...
									<div class="pre-content">
										<div class="breadcrumb">
											<span class="item-breadcrumb separator home">
												<a href="#">Home</a>
											</span> 
										...
										<div class="content">
											...
											<div class="form-datos-parcela form-columnx2">
												<div class="form-group">
													...
													<div>
														<input type="text" readonly="readonly"
															class="form-control" value="<%=e1.getNombre()%>" />
													</div>
												</div>
												<div class="form-group">
													<div>
													...
													<div>
														<input type="text" readonly="readonly"
															class="form-control" value="<%=e1.getFecha()%>" />
													</div>
												</div>
												<div class="form-group">
													<div>
													...
													<div>
														<input type="text" readonly="readonly"
															class="form-control" value="<%=e1.getHora()%>" />
													</div>
												</div>
												<div class="form-group">
													<div>
													...
													<div>
														<input type="text" readonly="readonly"
															class="form-control" value="<%=e1.getLugar()%>" />
													</div>
												</div>
												<div class="form-group item-textarea">
													...
													<div>
														<textarea><%=e1.getDescripcion()%></textarea>
													</div>
												</div>
												<div class="form-actions">
