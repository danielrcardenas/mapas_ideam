								...
								<div class="content">
									<div id="form-loguin-header" role="form">
										<div class="form-group">
											...
											<input style="border-color: red" type="text" class="form-control" id="logName"
												name="logName" placeholder="incorrecto">
										</div>

										<div class="form-group">
											<label for="exampleInputPassword1"><%=msj.getString("home.pass")%></label>
											<input style="border-color: red" type="password" class="form-control" id="logPassword"
												name="logPassword" placeholder="incorrecta">
										</div>
