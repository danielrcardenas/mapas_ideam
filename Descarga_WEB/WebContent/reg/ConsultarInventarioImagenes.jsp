...
titulos[1] = 'Nombre';
titulos[2] = 'Formato';
titulos[3] = 'Fecha de adquisición';
titulos[4] = 'Fecha registro';
titulos[5] = 'Proyección';
titulos[6] = 'Número de bandas';
titulos[7] = 'Tamaño';
titulos[8] = 'Tipo de dato';
titulos[9] = 'Resolución';
titulos[10] = 'Nivel de georreferenciación';
titulos[11] = 'Tipo de imagen o mapa';
titulos[12] = 'Link metadato';
	...
	function filtraDatasets(){
		...
		//else{ 
			...
			if(fin.value != '' && ffi.value != ''){
				datasetsFiltrados = filtroFechas(fin.value, ffi.value, datasetsFiltrados, 3);
			}
			idActual=1;
						...
						<div class="section-inner clearfix">
							...
							<div id="content">
								<div class="content-inner">
									...
									<!-- precontent -->
									<form id="generarReporte" name="generarGeporte" action="<%=basePath%>generarReporteServlet" method="post" onsubmit="validarRepDatasets()">
												<div class="form-datos-parcela form-columnx2" role="form">
														...
														<input
															...
															onclick="location.href='<%=basePath%>reg/home1.jsp';">
